    ...
    <div x-show="showModal" class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" style="display: none">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <div class="bg-gray-50 px-3 pt-3 pb-4 sm:px-6 sm:py-2 sm:pb-4 overflow-auto" style="max-height: calc(100vh - 200px);">
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="grid grid-cols-3 gap-5 mt-4">
                                ...
                                @else
                                    <div class="relative cursor-pointer selectParameters rounded-md shadow-md bg-white" wire:click="selectParameter({{ $parameter->id }})">
                                @endif
                                        <div class="mj-parameter-wrapper">
                                            <div class="d-flex justify-content-start align-items-center">
                                                ...
                                                <div class="parameter-name px-2 text-md my-2">{{ $parameter->name }}</div>
                                            </div>
                                        </div>
                                        @if(in_array($parameter->id, $selectedParameters))
